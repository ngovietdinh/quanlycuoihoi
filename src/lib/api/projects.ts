...
export async function createProject(dto: { name:string; description?:string; event_date?:string; venue?:string; budget_total:number }): Promise<ApiResult<Project>> {
  try {
...
export async function updateProject(id: string, dto: Partial<{ name:string; description:string; event_date:string; venue:string; budget_total:number }>): Promise<ApiResult<Project>> {
  try {
